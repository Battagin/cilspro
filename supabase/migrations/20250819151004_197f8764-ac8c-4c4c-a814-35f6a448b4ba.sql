-- ASCOLTO (demo) - using UUID and correct skill types
INSERT INTO public.demo_exercises (id, title, skill_type, content, created_at, updated_at)
VALUES
(gen_random_uuid(), 'Appuntamento in Comune', 'ascolto', 
'{
...
INSERT INTO public.demo_exercises (id, title, skill_type, content, created_at, updated_at)
VALUES
(gen_random_uuid(), 'Avviso dell''ufficio anagrafe', 'lettura', 
'{
...
INSERT INTO public.demo_exercises (id, title, skill_type, content, created_at, updated_at)
VALUES
(gen_random_uuid(), 'Email di richiesta informazioni', 'scrittura', 
'{
...
-- ORALE (demo) - using correct skill_type 'produzione_orale'
INSERT INTO public.demo_exercises (id, title, skill_type, content, created_at, updated_at)
VALUES
(gen_random_uuid(), 'Presentazione personale', 'produzione_orale', 
'{
